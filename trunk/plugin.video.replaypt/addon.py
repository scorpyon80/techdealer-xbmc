...
elif mode==411: novelasgravadas.CATEGORIES_novelasgravadas()
elif mode==412: novelasgravadas.listar_episodios(url)
elif mode==413: novelasgravadas.procurar_fontes(url,name,iconimage)
elif mode==414: novelasgravadas.alterar_vista(novelasgravadas.novelasgravadas_url)
...
elif mode==418: vernovelas.CATEGORIES_vernovelas()
